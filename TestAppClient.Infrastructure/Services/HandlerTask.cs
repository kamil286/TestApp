...
namespace TestAppClient.Infrastructure.Services
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private Func<CardException, Task> _onCustomErrorAsync;
        private Func<CardException, Logger, Task> _onCustomErrorWithLoggerAsync;
        ...
        public IHandlerTask OnCustomError(Func<CardException, Task> onCustomError,
        ...
        public IHandlerTask OnCustomError(Func<CardException, Logger, Task> onCustomError,
            bool propagateException = false, bool executeOnError = false)
        {
        ...
        {
            var customException = exception as CardException;
